...
const DEFAULT_SEMESTER_SORTING: ExtendedColumnSort<Semester>[] = [
  { id: "createdAt", desc: true },
];
const DEFAULT_SESSION_SORTING: ExtendedColumnSort<CourseSession>[] = [
  { id: "createdAt", desc: true },
];
...
function SemestersSection() {
  const { page, perPage, sorting } = useNamespacedTableQueryState<Semester>(
    "sem",
    DEFAULT_SEMESTER_SORTING,
  );
...
function CourseSessionsSection() {
  const { page, perPage, sorting } =
    useNamespacedTableQueryState<CourseSession>("cs", DEFAULT_SESSION_SORTING);
