      ...
      <div className="min-w-0 flex-1">
        {isEditingTitle ? (
          <Input
            ...
            className="h-6 border-none px-1 py-0 text-sm shadow-none ring-0 focus-visible:ring-0"
          />
        ) : (
          <span
            onClick={() => setIsEditingTitle(true)}
            className={cn(
              "cursor-text truncate text-sm font-medium",
        ...
        {descriptionPreview && (
          <div className="mt-0.5 relative max-w-full">
            {descExpanded ? (
              <div className="chat-markdown text-xs min-w-0 pr-5">
