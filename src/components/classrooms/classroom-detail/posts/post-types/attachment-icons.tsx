...
export function FileIconPdf({ size = 20, className, ...props }: FileIconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function FileIconDoc({ size = 20, className, ...props }: FileIconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function FileIconCsv({ size = 20, className, ...props }: FileIconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function FileIconXls({ size = 20, className, ...props }: FileIconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function FileIconPpt({ size = 20, className, ...props }: FileIconProps) {
  return (
    <svg
      width={size}
      height={size}
      ...
      {...props}
    >
      {/* Paste Untitled UI PPT SVG here */}
    </svg>
  );
}

export function FileIconPptx({
  size = 20,
  className,
  ...props
}: FileIconProps) {
...
export function FileIconZip({ size = 20, className, ...props }: FileIconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function FileIconTxt({ size = 20, className, ...props }: FileIconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function FileIconGeneric({
  size = 20,
  className,
  ...props
}: FileIconProps) {
