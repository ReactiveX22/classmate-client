    ...
    <section id='contact' className='py-24 md:py-32 px-4 sm:px-6 relative overflow-hidden'>
      ...
      <div className='max-w-3xl mx-auto text-center space-y-8 relative z-10'>
        ...
        <p className='text-lg sm:text-xl text-muted-foreground text-balance max-w-xl mx-auto'>
          Join hundreds of educators and thousands of students already using ClassMate to streamline their academic life.
        </p>
        <div className='pt-4'>
          <Button size='lg' nativeButton={false} render={<Link href='/signup' />} className='h-14 px-10 text-base rounded-full shadow-2xl shadow-primary/30 hover:shadow-primary/50 hover:-translate-y-0.5 transition-all group glowing-button'>
