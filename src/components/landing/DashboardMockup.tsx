          ...
          <div className="flex-1 p-5">
            ...
            <div className="grid grid-cols-3 gap-2 mb-4">
              {[
                ...
                <div
                  key={stat.label}
                  className="p-2.5 rounded-xl bg-muted/40 border border-border/30"
                >
            ...
            {[
              ...
              <div
                key={notice.title}
                className="flex items-start gap-2.5 p-2.5 rounded-xl bg-muted/30 border border-border/20 mb-2"
              >
                <div
                  className={`mt-0.5 px-1.5 py-0.5 rounded text-[9px] font-bold flex-shrink-0 ${notice.color}`}
                >
                  {notice.type}
                </div>
