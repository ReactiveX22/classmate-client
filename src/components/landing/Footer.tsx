...
const footerLinks = {
  Product: [
    ...
    { title: 'Roadmap', href: 'https://github.com/ReactiveX22/classmate-client/issues', external: true },
  ],
  Developers: [
    { title: 'GitHub', href: 'https://github.com/ReactiveX22/classmate-client', external: true },
    { title: 'Backend Repo', href: 'https://github.com/ReactiveX22/classmate-backend', external: true },
    { title: 'Report an Issue', href: 'https://github.com/ReactiveX22/classmate-client/issues/new', external: true },
    { title: 'Self-host Guide', href: 'https://github.com/ReactiveX22/classmate-client#readme', external: true },
  ],
  Platform: [
      ...
      <div className='max-w-7xl mx-auto px-6 pt-16 pb-10'>
        <div className='grid grid-cols-2 md:grid-cols-4 gap-10 mb-14'>
          ...
          <div className='col-span-2 md:col-span-1 space-y-5'>
            <Link href='/' className='flex items-center gap-2.5 font-bold text-xl group w-fit'>
            ...
            <p className='text-sm text-muted-foreground leading-relaxed max-w-[220px]'>
              The open-source academic management platform for modern institutions.
            </p>
            <Link
          ...
          {Object.entries(footerLinks).map(([category, links]) => (
            <div key={category}>
              <h3 className='font-semibold text-sm mb-5 text-foreground'>{category}</h3>
