      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          >
            <Badge
              variant="outline"
              className="px-3 py-1 border-primary/30 bg-primary/5"
            >
            ...
            <p className="text-lg text-muted-foreground leading-relaxed">
              Powered by WebSockets, every notice — urgent alerts, department
              updates, event announcements — reaches students and faculty the
              moment it&apos;s published. No refreshes, no delays.
            </p>
          </motion.div>
