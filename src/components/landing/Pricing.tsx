    ...
    <section id='pricing' className='relative py-24 md:py-32 px-4 sm:px-6'>
      ...
      <div className='relative max-w-7xl mx-auto'>
        ...
        <div className='text-center max-w-2xl mx-auto mb-16 md:mb-20'>
          ...
          >
            Classmate is open source and free to self-host. Managed cloud and enterprise options are on the roadmap.
          </motion.p>
        </div>
            ...
            >
              ...
              <div className='mb-8'>
                <div className='flex items-end gap-1'>
                  <span className={`font-extrabold tracking-tight ${plan.price === 'Custom' || plan.price === 'Coming Soon' ? 'text-2xl' : 'text-4xl'}`}>
                    {plan.price}
                  </span>
                  {plan.period && (
              ...
              <ul className='space-y-3 mb-8 flex-1'>
                {plan.features.map((f) => (
                  <li key={f} className='flex items-center gap-2.5 text-sm text-muted-foreground'>
                    <IconCheck
                      size={16}
                      className={plan.highlighted ? 'text-primary flex-shrink-0' : 'text-emerald-500 flex-shrink-0'}
                    />
                    {f}
                  </li>
                ))}
