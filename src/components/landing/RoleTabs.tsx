...
const roles = [
  {
    ...
    description:
      "View upcoming deadlines, join classes with a code, and access course materials from any device. Never miss an assignment with smart alerts.",
  },
  {
    id: "teacher",
    label: "Teacher",
    ...
    description:
      "Create classrooms in seconds, automate grading workflows, and engage students with real-time posts. Track attendance effortlessly.",
  },
  {
    id: "admin",
    label: "Admin",
    ...
    description:
      "Manage user roles, broadcast official notices, and monitor academic progress across the organization. Secure and compliant.",
  },
];
          ...
          <div className="inline-flex items-center gap-2 p-1 rounded-full border bg-muted/50 backdrop-blur-sm">
            {roles.map((role) => (
              <button
                ...
                className={`cursor-pointer relative flex items-center gap-2 px-5 py-2.5 rounded-full text-sm font-medium transition-colors z-10 ${
                  activeRole === role.id
