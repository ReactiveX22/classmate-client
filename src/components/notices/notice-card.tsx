...
export function NoticeCard({
  ...
  return (
    <div
      onClick={onClick}
      className={cn(
        "group flex flex-col gap-2 p-4 rounded-xl border bg-card hover:bg-accent/50 cursor-pointer transition-all",
        isSelected &&
    ...
    >
      <div className="flex items-start justify-between gap-2">
        <h3
          className={cn(
            "font-medium line-clamp-2 leading-tight text-sm",
